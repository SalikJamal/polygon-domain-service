...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("TRON Name Service", "TRON") {
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        require(msg.value >= _price, "Not enough MATIC to register this domain");
        
        // Combine the name passed into the function with TLD
